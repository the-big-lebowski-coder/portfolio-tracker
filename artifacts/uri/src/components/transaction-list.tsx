import {
  useListUriTransactions,
  useDeleteUriTransaction,
  getListUriTransactionsQueryKey,
  getGetUriBalanceQueryKey,
  getGetUriSummaryQueryKey,
...
export function TransactionList() {
  const { data: transactions, isLoading } = useListUriTransactions();
  const deleteTransaction = useDeleteUriTransaction();
        ...
        return (
          ...
          >
            ...
            <div className="flex items-center gap-3">
              <div className={cn("text-lg font-bold", isIncome ? "text-emerald-600" : "text-foreground")}>
